...
# The URL only needs tracked_source before any # anchor; other tracking fields have defaults.
# Launch short URLs may redirect to anchored GitHub targets; the anchor is intentional.
...
REPO_URL="${REPO_URL:-${1:-https://github.com/agent-valve-ai/Agent-Valve?tracked_source=github_readme#direct-jotform-curl-submission}}"
